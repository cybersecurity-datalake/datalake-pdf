...
O dataset foi construído a partir da integração de cinco fontes públicas de vulnerabilidades, selecionadas por sua relevância, complementaridade e ampla utilização pela comunidade de segurança cibernética. Essas fontes fornecem informações sobre identificação de vulnerabilidades, métricas de severidade, fraquezas de software, exploração conhecida e pacotes afetados, permitindo reunir diferentes perspectivas sobre uma mesma vulnerabilidade. A Tabela~\ref{tab:data_sources} resume as fontes utilizadas, o tipo de informação obtida e sua frequência de atualização.
