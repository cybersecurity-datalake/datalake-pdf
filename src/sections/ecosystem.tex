...
\begin{table}[htbp]
    ...
    {\hfuzz=3pt\resizebox{\textwidth}{!}{%
            \begin{tabular}{|>{\raggedright\arraybackslash}p{2.4cm}|>{\raggedright\arraybackslash}p{2.7cm}|>{\raggedright\arraybackslash}p{2.7cm}|>{\raggedright\arraybackslash}p{2.9cm}|>{\raggedright\arraybackslash}p{3.6cm}|}
                \hline
