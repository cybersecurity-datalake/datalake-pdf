...
\begin{table}[htbp]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|>{\raggedright\arraybackslash}p{2.9cm}|>{\raggedright\arraybackslash}p{2.3cm}|>{\raggedright\arraybackslash}p{3.0cm}|>{\raggedright\arraybackslash}p{3.0cm}|>{\raggedright\arraybackslash}p{3.1cm}|>{\raggedright\arraybackslash}p{3.4cm}|}
            \hline
            \textbf{Referência}                                              & \textbf{Objetivo}                                              & \textbf{Fontes/\allowbreak abordagem}         & \textbf{Achado principal}                                                        & \textbf{Relação com este trabalho}               & \textbf{Lacuna explorada pelo dataset proposto}                                           \\
            \hline
